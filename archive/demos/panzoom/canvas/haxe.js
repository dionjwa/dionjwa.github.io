...
if(!com.pblabs.components.scene.js.canvas) com.pblabs.components.scene.js.canvas = {}
com.pblabs.components.scene.js.canvas.Canvas2DComponent = function(p) { if( p === $_ ) return; {
...
com.pblabs.components.scene.js.canvas.Canvas2DComponent.__name__ = ["com","pblabs","components","scene","js","canvas","Canvas2DComponent"];
com.pblabs.components.scene.js.canvas.Canvas2DComponent.__super__ = com.pblabs.components.scene.BaseScene2DComponent;
for(var k in com.pblabs.components.scene.BaseScene2DComponent.prototype ) com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype[k] = com.pblabs.components.scene.BaseScene2DComponent.prototype[k];
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype._backBuffer = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype._isContentsDirty = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.alpha = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.boundingBox = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.cacheAsBitmap = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.centerX = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.centerY = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.composite = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.dirtyContents = function() {
	this._isContentsDirty = true;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.dirtyTransform = function() {
	this.set_isTransformDirty(true);
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.draw = function(ctx) {
	throw "Subclasses must override";
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.isCacheAsBitmap = function() {
	return this._backBuffer != null;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.onReset = function() {
	com.pblabs.components.scene.BaseScene2DComponent.prototype.onReset.apply(this,[]);
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.packBounds = function() {
...
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.redrawBackBuffer = function() {
	...
	haxe.Log.trace("Drawing backbuffer " + this.boundingBox,{ fileName : "Canvas2DComponent.hx", lineNumber : 222, className : "com.pblabs.components.scene.js.canvas.Canvas2DComponent", methodName : "redrawBackBuffer"});
	...
	this.draw(ctx);
	haxe.Log.trace(this.transform,{ fileName : "Canvas2DComponent.hx", lineNumber : 237, className : "com.pblabs.components.scene.js.canvas.Canvas2DComponent", methodName : "redrawBackBuffer"});
	this._isContentsDirty = false;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.render = function(ctx) {
...
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.setCacheAsBitmap = function(on) {
	if(on) {
		this.redrawBackBuffer();
	}
	else {
...
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.setCenterX = function(centerX) {
	this.centerX = centerX;
	this.set_isTransformDirty(true);
	return this.centerX;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.setCenterY = function(centerY) {
	this.centerY = centerY;
	this.set_isTransformDirty(true);
	return this.centerY;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.setShadowBlur = function(shadowBlur) {
	this.shadowBlur = shadowBlur;
	this._isContentsDirty = true;
	return this.shadowBlur;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.setShadowColor = function(shadowColor) {
	this.shadowColor = shadowColor;
	this._isContentsDirty = true;
	return this.shadowColor;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.setShadowOffsetX = function(shadowOffsetX) {
	this.shadowOffsetX = shadowOffsetX;
	this._isContentsDirty = true;
	return this.shadowOffsetX;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.setShadowOffsetY = function(shadowOffsetY) {
	this.shadowOffsetY = shadowOffsetY;
	this._isContentsDirty = true;
	return this.shadowOffsetY;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.set_isTransformDirty = function(val) {
	if(val && this.get_layer() != null) {
		this.get_layer().isTransformDirty = true;
	}
	return com.pblabs.components.scene.BaseScene2DComponent.prototype.set_isTransformDirty.apply(this,[val]);
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.shadowBlur = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.shadowColor = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.shadowOffsetX = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.shadowOffsetY = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.transform = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.updateTransform = function() {
	var cos = Math.cos(this.get_angle());
	var sin = Math.sin(this.get_angle());
	var cx = -this.centerX;
	var cy = -this.centerY;
	if(this._backBuffer != null) {
	...
	this.transform[0] = this.get_scale() * cos;
	this.transform[1] = this.get_scale() * sin;
	this.transform[2] = this.get_scale() * -sin;
	this.transform[3] = this.get_scale() * cos;
	this.transform[4] = Math.floor((cx * this.transform[0] + cy * this.transform[2]) + this.get_x());
	this.transform[5] = Math.floor((cx * this.transform[1] + cy * this.transform[3]) + this.get_y());
	this._isTransformDirty = false;
}
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.visible = null;
com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.__class__ = com.pblabs.components.scene.js.canvas.Canvas2DComponent;
com.pblabs.components.scene.ShapeComponent = function(fillcolor,borderWidth,borderColor) { if( fillcolor === $_ ) return; {
	...
	com.pblabs.components.scene.js.canvas.Canvas2DComponent.apply(this,[]);
	this._fillColor = fillcolor;
	this._borderColor = borderColor;
	this._borderWidth = borderWidth;
}}
com.pblabs.components.scene.ShapeComponent.__name__ = ["com","pblabs","components","scene","ShapeComponent"];
com.pblabs.components.scene.ShapeComponent.__super__ = com.pblabs.components.scene.js.canvas.Canvas2DComponent;
for(var k in com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype ) com.pblabs.components.scene.ShapeComponent.prototype[k] = com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype[k];
...
com.pblabs.components.scene.ShapeComponent.prototype.onReset = function() {
	com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.onReset.apply(this,[]);
	this.redraw();
}
...
com.pblabs.components.scene.ShapeComponent.prototype.set_height = function(val) {
	com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.set_height.apply(this,[val]);
	this.redraw();
	return val;
}
com.pblabs.components.scene.ShapeComponent.prototype.set_width = function(val) {
	com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.set_width.apply(this,[val]);
	this.redraw();
	return val;
}
...
com.pblabs.components.scene.RectangleShape.prototype.draw = function(ctx) {
	ctx.fillStyle = com.pblabs.util.StringUtil.toColorString(this.get_fillColor(),"#");
	ctx.fillRect(-this.get_width() / 2,-this.get_height() / 2,this.get_width(),this.get_height());
	ctx.strokeStyle = com.pblabs.util.StringUtil.toColorString(this.get_borderColor(),"#");
	ctx.lineWidth = this.get_borderWidth();
	ctx.beginPath();
...
com.pblabs.components.scene.ImageComponent.__super__ = com.pblabs.components.scene.js.canvas.Canvas2DComponent;
for(var k in com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype ) com.pblabs.components.scene.ImageComponent.prototype[k] = com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype[k];
...
com.pblabs.components.scene.ImageComponent.prototype.displayObject = null;
com.pblabs.components.scene.ImageComponent.prototype.draw = function(ctx) {
	ctx.drawImage(this.displayObject,-this.displayObject.width / 2,-this.displayObject.height / 2);
}
com.pblabs.components.scene.ImageComponent.prototype.onAdd = function() {
	com.pblabs.components.scene.js.canvas.Canvas2DComponent.prototype.onAdd.apply(this,[]);
...
com.pblabs.components.scene.ImageComponent.prototype.set_displayObject = function(val) {
...
com.pblabs.engine.resource.XMLResource.prototype.create = function(name) {
	if(name != null) {
		com.pblabs.engine.debug.Log.error("create(name): name argument is ignored",{ fileName : "XMLResource.hx", lineNumber : 52, className : "com.pblabs.engine.resource.XMLResource", methodName : "create"});
	}
...
com.pblabs.engine.resource.XMLResource.prototype.load = function(onLoad,onError) {
	...
	default:{
		com.pblabs.engine.debug.Log.error("Resouce source type not handled: " + this._source,{ fileName : "XMLResource.hx", lineNumber : 42, className : "com.pblabs.engine.resource.XMLResource", methodName : "load"});
	}break;
	}
	this._source = null;
}
...
Demo = function(p) { if( p === $_ ) return; {
	...
	this.game.getManager(com.pblabs.engine.resource.IResourceManager).load($closure(this,"startGame"),function(e) {
		haxe.Log.trace("Error loading: " + e,{ fileName : "Demo.hx", lineNumber : 71, className : "Demo", methodName : "new"});
	});
}}
Demo.__name__ = ["Demo"];
Demo.main = function() {
...
com.pblabs.components.scene.js.canvas.CanvasLayer = function(p) { if( p === $_ ) return; {
...
com.pblabs.components.scene.js.canvas.CanvasLayer.__name__ = ["com","pblabs","components","scene","js","canvas","CanvasLayer"];
com.pblabs.components.scene.js.canvas.CanvasLayer.__super__ = com.pblabs.components.scene.js.JSLayer;
for(var k in com.pblabs.components.scene.js.JSLayer.prototype ) com.pblabs.components.scene.js.canvas.CanvasLayer.prototype[k] = com.pblabs.components.scene.js.JSLayer.prototype[k];
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype._tempPoint = null;
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.addedToParent = function() {
	if(this.canvas == null) {
		this.canvas = this.createCanvas();
	}
	this.canvas.width = Std["int"](this.parent.get_sceneView().get_width());
	this.canvas.height = Std["int"](this.parent.get_sceneView().get_height());
	this.ctx = this.canvas.getContext("2d");
	this.div.appendChild(this.canvas);
	this.isDirty = true;
	com.pblabs.components.scene.js.JSLayer.prototype.addedToParent.apply(this,[]);
}
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.canvas = null;
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.createCanvas = function() {
...
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.ctx = null;
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.isDirty = null;
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.isTransformDirty = null;
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.onFrame = function(dt) {
	if(!this.isDirty && !this.isTransformDirty) {
		return;
	}
	if(this.ctx == null) {
		return;
	...
	if(this.isTransformDirty) {
		...
		com.pblabs.components.scene.SceneUtil.calculateOutPoint(this._tempPoint,this.get_scene().sceneAlignment,this.get_scene().get_sceneView().get_width(),this.get_scene().get_sceneView().get_height());
		this.ctx.translate(this._tempPoint.x,this._tempPoint.y);
		this.ctx.rotate(this.get_scene().get_rotation());
		this.ctx.scale(this.get_scene().get_zoom(),this.get_scene().get_zoom());
		this.ctx.translate(this.get_scene().get_x() * this._parallaxFactor,this.get_scene().get_y() * this._parallaxFactor);
	}
	else {
		this.ctx.save();
		this.ctx.setTransform(1,0,0,1,0,0);
...
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.onRemove = function() {
	com.pblabs.components.scene.js.JSLayer.prototype.onRemove.apply(this,[]);
	this.ctx = null;
}
com.pblabs.components.scene.js.canvas.CanvasLayer.prototype.__class__ = com.pblabs.components.scene.js.canvas.CanvasLayer;
com.pblabs.components.scene.js.canvas.CanvasLayer.__interfaces__ = [com.pblabs.engine.time.IAnimatedObject];
...
com.pblabs.components.scene.js.canvas.CanvasScene2D = function(p) { if( p === $_ ) return; {
	com.pblabs.components.scene.js.JSSceneManager.apply(this,[]);
}}
com.pblabs.components.scene.js.canvas.CanvasScene2D.__name__ = ["com","pblabs","components","scene","js","canvas","CanvasScene2D"];
com.pblabs.components.scene.js.canvas.CanvasScene2D.__super__ = com.pblabs.components.scene.js.JSSceneManager;
for(var k in com.pblabs.components.scene.js.JSSceneManager.prototype ) com.pblabs.components.scene.js.canvas.CanvasScene2D.prototype[k] = com.pblabs.components.scene.js.JSSceneManager.prototype[k];
com.pblabs.components.scene.js.canvas.CanvasScene2D.prototype.updateTransform = function() {
	{
		var _g = 0, _g1 = this.children;
		while(_g < _g1.length) {
			var layer = _g1[_g];
...
com.pblabs.components.scene.js.canvas.CanvasScene2D.prototype.__class__ = com.pblabs.components.scene.js.canvas.CanvasScene2D;
...
com.pblabs.components.scene.CircleShape.prototype.draw = function(ctx) {
	ctx.beginPath();
	ctx.arc(0,0,this.get_radius(),0,Math.PI * 2,true);
	ctx.fillStyle = com.pblabs.util.StringUtil.toColorString(this.get_fillColor(),"#");
	ctx.fill();
	ctx.closePath();
	ctx.strokeStyle = com.pblabs.util.StringUtil.toColorString(this.get_borderColor(),"#");
...
com.pblabs.components.scene.js.canvas.Canvas2DComponent.__rtti = "<class path=\"com.pblabs.components.scene.js.canvas.Canvas2DComponent\" params=\"\" file=\"/usr/lib/haxe/lib/hydrax/0,1/com/pblabs/components/scene/js/canvas/Canvas2DComponent.hx\">\n\t<extends path=\"com.pblabs.components.scene.BaseScene2DComponent\"><c path=\"com.pblabs.components.scene.js.canvas.CanvasLayer\"/></extends>\n\t<alpha public=\"1\"><c path=\"Float\"/></alpha>\n\t<visible public=\"1\"><e path=\"Bool\"/></visible>\n\t<composite public=\"1\"><c path=\"String\"/></composite>\n\t<shadowColor public=\"1\" set=\"setShadowColor\"><c path=\"String\"/></shadowColor>\n\t<shadowOffsetX public=\"1\" set=\"setShadowOffsetX\"><c path=\"Float\"/></shadowOffsetX>\n\t<shadowOffsetY public=\"1\" set=\"setShadowOffsetY\"><c path=\"Float\"/></shadowOffsetY>\n\t<shadowBlur public=\"1\" set=\"setShadowBlur\"><c path=\"Float\"/></shadowBlur>\n\t<transform public=\"1\"><t path=\"com.pblabs.components.scene.js.canvas.Matrix\"/></transform>\n\t<boundingBox public=\"1\"><t path=\"com.pblabs.components.scene.js.canvas.Rect\"/></boundingBox>\n\t<cacheAsBitmap public=\"1\" get=\"isCacheAsBitmap\" set=\"setCacheAsBitmap\"><e path=\"Bool\"/></cacheAsBitmap>\n\t<centerX public=\"1\" set=\"setCenterX\"><c path=\"Float\"/></centerX>\n\t<centerY public=\"1\" set=\"setCenterY\"><c path=\"Float\"/></centerY>\n\t<setCenterX public=\"1\" get=\"inline\" set=\"null\" line=\"56\"><f a=\"centerX\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></setCenterX>\n\t<setCenterY public=\"1\" get=\"inline\" set=\"null\" line=\"63\"><f a=\"centerY\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></setCenterY>\n\t<onReset set=\"method\" line=\"90\" override=\"1\"><f a=\"\"><e path=\"Void\"/></f></onReset>\n\t<set_isTransformDirty set=\"method\" line=\"96\" override=\"1\"><f a=\"val\">\n\t<e path=\"Bool\"/>\n\t<e path=\"Bool\"/>\n</f></set_isTransformDirty>\n\t<setShadowColor public=\"1\" get=\"inline\" set=\"null\" line=\"105\"><f a=\"shadowColor\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></setShadowColor>\n\t<setShadowOffsetX public=\"1\" get=\"inline\" set=\"null\" line=\"112\"><f a=\"shadowOffsetX\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></setShadowOffsetX>\n\t<setShadowOffsetY public=\"1\" get=\"inline\" set=\"null\" line=\"119\"><f a=\"shadowOffsetY\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></setShadowOffsetY>\n\t<setShadowBlur public=\"1\" get=\"inline\" set=\"null\" line=\"126\"><f a=\"shadowBlur\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></setShadowBlur>\n\t<dirtyTransform public=\"1\" get=\"inline\" set=\"null\" line=\"133\"><f a=\"\"><e path=\"Void\"/></f></dirtyTransform>\n\t<dirtyContents public=\"1\" get=\"inline\" set=\"null\" line=\"138\"><f a=\"\"><e path=\"Void\"/></f></dirtyContents>\n\t<updateTransform set=\"method\" line=\"143\"><f a=\"\"><e path=\"Void\"/></f></updateTransform>\n\t<setCacheAsBitmap public=\"1\" set=\"method\" line=\"192\"><f a=\"on\">\n\t<e path=\"Bool\"/>\n\t<e path=\"Bool\"/>\n</f></setCacheAsBitmap>\n\t<isCacheAsBitmap public=\"1\" get=\"inline\" set=\"null\" line=\"202\"><f a=\"\"><e path=\"Bool\"/></f></isCacheAsBitmap>\n\t<redrawBackBuffer set=\"method\" line=\"207\"><f a=\"\"><e path=\"Void\"/></f></redrawBackBuffer>\n\t<render public=\"1\" set=\"method\" line=\"243\"><f a=\"ctx\">\n\t<t path=\"easel.display.Context2d\"/>\n\t<e path=\"Void\"/>\n</f></render>\n\t<draw public=\"1\" set=\"method\" line=\"296\"><f a=\"ctx\">\n\t<t path=\"easel.display.Context2d\"/>\n\t<e path=\"Void\"/>\n</f></draw>\n\t<packBounds public=\"1\" set=\"method\" line=\"301\"><f a=\"\"><e path=\"Void\"/></f></packBounds>\n\t<_isContentsDirty><e path=\"Bool\"/></_isContentsDirty>\n\t<_backBuffer><t path=\"easel.display.Canvas\"/></_backBuffer>\n\t<new public=\"1\" set=\"method\" line=\"70\"><f a=\"\"><e path=\"Void\"/></f></new>\n</class>";
com.pblabs.components.scene.ShapeComponent.__rtti = "<class path=\"com.pblabs.components.scene.ShapeComponent\" params=\"\" file=\"/usr/lib/haxe/lib/libdamago/0,1/com/pblabs/components/scene/ShapeComponent.hx\">\n\t<extends path=\"com.pblabs.components.scene.js.canvas.Canvas2DComponent\"/>\n\t<fillColor public=\"1\" get=\"get_fillColor\" set=\"set_fillColor\"><c path=\"Int\"/></fillColor>\n\t<borderColor public=\"1\" get=\"get_borderColor\" set=\"set_borderColor\"><c path=\"Int\"/></borderColor>\n\t<borderWidth public=\"1\" get=\"get_borderWidth\" set=\"set_borderWidth\"><c path=\"Float\"/></borderWidth>\n\t<onReset set=\"method\" line=\"48\" override=\"1\"><f a=\"\"><e path=\"Void\"/></f></onReset>\n\t<set_width set=\"method\" line=\"54\" override=\"1\"><f a=\"val\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></set_width>\n\t<set_height set=\"method\" line=\"61\" override=\"1\"><f a=\"val\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></set_height>\n\t<redraw set=\"method\" line=\"68\"><f a=\"\"><e path=\"Void\"/></f></redraw>\n\t<get_fillColor set=\"method\" line=\"73\"><f a=\"\"><c path=\"Int\"/></f></get_fillColor>\n\t<set_fillColor set=\"method\" line=\"78\"><f a=\"val\">\n\t<c path=\"Int\"/>\n\t<c path=\"Int\"/>\n</f></set_fillColor>\n\t<get_borderColor set=\"method\" line=\"85\"><f a=\"\"><c path=\"Int\"/></f></get_borderColor>\n\t<set_borderColor set=\"method\" line=\"90\"><f a=\"val\">\n\t<c path=\"Int\"/>\n\t<c path=\"Int\"/>\n</f></set_borderColor>\n\t<get_borderWidth set=\"method\" line=\"97\"><f a=\"\"><c path=\"Float\"/></f></get_borderWidth>\n\t<set_borderWidth set=\"method\" line=\"102\"><f a=\"val\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n</f></set_borderWidth>\n\t<_fillColor><c path=\"Int\"/></_fillColor>\n\t<_borderColor><c path=\"Int\"/></_borderColor>\n\t<_borderWidth><c path=\"Float\"/></_borderWidth>\n\t<new public=\"1\" set=\"method\" line=\"18\"><f a=\"?fillcolor:?borderWidth:?borderColor\">\n\t<c path=\"Int\"/>\n\t<c path=\"Float\"/>\n\t<c path=\"Int\"/>\n\t<e path=\"Void\"/>\n</f></new>\n</class>";
com.pblabs.components.scene.RectangleShape.__rtti = "<class path=\"com.pblabs.components.scene.RectangleShape\" params=\"\" file=\"/usr/lib/haxe/lib/libdamago/0,1/com/pblabs/components/scene/RectangleShape.hx\">\n\t<extends path=\"com.pblabs.components.scene.ShapeComponent\"/>\n\t<onAdd set=\"method\" line=\"58\" override=\"1\"><f a=\"\"><e path=\"Void\"/></f></onAdd>\n\t<redraw set=\"method\" line=\"71\" override=\"1\"><f a=\"\"><e path=\"Void\"/></f></redraw>\n\t<draw public=\"1\" set=\"method\" line=\"90\" override=\"1\"><f a=\"ctx\">\n\t<t path=\"easel.display.Context2d\"/>\n\t<e path=\"Void\"/>\n</f></draw>\n\t<new public=\"1\" set=\"method\" line=\"11\"><f a=\"?w:?h:?color\">\n\t<c path=\"Float\"/>\n\t<c path=\"Float\"/>\n\t<c path=\"Int\"/>\n\t<e path=\"Void\"/>\n</f></new>\n</class>";
com.pblabs.components.scene.ImageComponent.__rtti = "<class path=\"com.pblabs.components.scene.ImageComponent\" params=\"\" file=\"/usr/lib/haxe/lib/libdamago/0,1/com/pblabs/components/scene/ImageComponent.hx\">\n\t<extends path=\"com.pblabs.components.scene.js.canvas.Canvas2DComponent\"/>\n\t<resource public=\"1\">\n\t\t<c path=\"com.pblabs.engine.resource.ImageResource\"/>\n\t\t<haxe_doc> The IResource name and item id.  Id can be null </haxe_doc>\n\t</resource>\n\t<displayObject public=\"1\" set=\"set_displayObject\"><t path=\"js.Image\"/></displayObject>\n\t<set_displayObject set=\"method\" line=\"29\"><f a=\"val\">\n\t<t path=\"js.Image\"/>\n\t<t path=\"js.Image\"/>\n</f></set_displayObject>\n\t<draw public=\"1\" set=\"method\" line=\"34\" override=\"1\"><f a=\"ctx\">\n\t<t path=\"easel.display.Context2d\"/>\n\t<e path=\"Void\"/>\n</f></draw>\n\t<containsScreenPoint public=\"1\" set=\"method\" line=\"45\" override=\"1\"><f a=\"pos\">\n\t<c path=\"com.pblabs.geom.Vector2\"/>\n\t<e path=\"Bool\"/>\n</f></containsScreenPoint>\n\t<onAdd set=\"method\" line=\"68\" override=\"1\"><f a=\"\"><e path=\"Void\"/></f></onAdd>\n\t<new public=\"1\" set=\"method\" line=\"40\"><f a=\"\"><e path=\"Void\"/></f></new>\n\t<haxe_doc>\n  * Cross platform Image using Scene2D component.\n  </haxe_doc>\n</class>";
...
com.pblabs.components.scene.js.canvas.CanvasLayer.__rtti = "<class path=\"com.pblabs.components.scene.js.canvas.CanvasLayer\" params=\"\" file=\"/usr/lib/haxe/lib/hydrax/0,1/com/pblabs/components/scene/js/canvas/CanvasLayer.hx\">\n\t<extends path=\"com.pblabs.components.scene.js.JSLayer\">\n\t\t<c path=\"com.pblabs.components.scene.js.canvas.CanvasScene2D\"/>\n\t\t<c path=\"com.pblabs.components.scene.js.canvas.Canvas2DComponent\"/>\n\t</extends>\n\t<implements path=\"com.pblabs.engine.time.IAnimatedObject\"/>\n\t<isDirty public=\"1\">\n\t\t<e path=\"Bool\"/>\n\t\t<haxe_doc> Children mark this when they're modified</haxe_doc>\n\t</isDirty>\n\t<isTransformDirty public=\"1\"><e path=\"Bool\"/></isTransformDirty>\n\t<canvas public=\"1\" set=\"null\"><t path=\"easel.display.Canvas\"/></canvas>\n\t<ctx public=\"1\" set=\"null\"><t path=\"easel.display.Context2d\"/></ctx>\n\t<onFrame public=\"1\" set=\"method\" line=\"43\"><f a=\"dt\">\n\t<c path=\"Float\"/>\n\t<e path=\"Void\"/>\n</f></onFrame>\n\t<addedToParent set=\"method\" line=\"90\" override=\"1\"><f a=\"\"><e path=\"Void\"/></f></addedToParent>\n\t<onRemove set=\"method\" line=\"104\" override=\"1\"><f a=\"\"><e path=\"Void\"/></f></onRemove>\n\t<createCanvas set=\"method\" line=\"111\"><f a=\"\"><t path=\"easel.display.Canvas\"/></f></createCanvas>\n\t<_tempPoint><c path=\"com.pblabs.geom.Vector2\"/></_tempPoint>\n\t<new public=\"1\" set=\"method\" line=\"33\"><f a=\"\"><e path=\"Void\"/></f></new>\n\t<haxe_doc>*****************************************************************************\n * Hydrax: haXe port of the PushButton Engine\n * Copyright (C) 2010 Dion Amago\n * For more information see http://github.com/dionjwa/Hydrax\n *\n * This file is licensed under the terms of the MIT license, which is included\n * in the License.html file at the root directory of this SDK.\n ****************************************************************************</haxe_doc>\n</class>";
